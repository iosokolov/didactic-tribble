...
POSTGRES_HOST = env.str("POSTGRES_HOST", default='airflow_db')   #'localhost'
...
AMQP_HOST = env.str('AMQP_HOST', default='rabbitmq')  # '0.0.0.0'
...
PROVIDER_A_URL = env.str('PROVIDER_A_URL', default='http://provider_a:9001')  # 'http://0.0.0.0:9001'
PROVIDER_B_URL = env.str('PROVIDER_A_URL', default='http://provider_b:9002')  # 'http://0.0.0.0:9002'

PROVIDER_A_TIMEOUT = env.int('PROVIDER_A_TIMEOUT', default=30+10)
PROVIDER_B_TIMEOUT = env.int('PROVIDER_A_TIMEOUT', default=60+10)

REDIS_HOST = env.str('REDIS_HOST', default='redis')  # 'localhost'
